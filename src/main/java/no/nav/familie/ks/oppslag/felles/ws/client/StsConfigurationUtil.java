...
public class StsConfigurationUtil {
    ...
    public static void configureStsForOnBehalfOfWithOidc(Client client, String stsURL, String stsUsername, String stsPassword) {
        STSClient stsClient = createBasicSTSClient(NAVSTSClient.StsClientType.SECURITYCONTEXT_TIL_SAML, client.getBus(), stsURL, stsUsername, stsPassword);
    ...
    private static STSClient createBasicSTSClient(NAVSTSClient.StsClientType type, Bus bus, String location, String username, String password) {
        ...
        try {
            ...
            throw new RuntimeException("Kunne ikke sette endpoint adresse");        }
